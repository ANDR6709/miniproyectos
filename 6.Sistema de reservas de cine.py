...
# a .Desarrolla un sistema simple que permita a los usuarios reservar 
# asientos en un cine.
# b. Pueden trabajar en funciones para seleccionar asientos, mostrar la disponibilidad y gestionar reservas.
