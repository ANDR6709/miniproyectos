# a. Desarrolla un programa que proporcione información meteorológica simulada para una ubicación específica.
# b. Pueden utilizar APIs externas para obtener datos reales o generar datos simulados.
